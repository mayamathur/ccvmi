...
#   sbatch -p qsu,owners,normal /home/groups/manishad/NMAR2/job_stitch.sbatch
# scontrol show job 33834701
# look at its out file:
# cd /home/groups/manishad/NMAR2
...
# setwd("/home/groups/manishad/NMAR2"); source("stitch_on_sherlock_NMAR2.R")
...
library(dplyr)
library(testthat)
# s = stitch_files(.results.singles.path = "/home/groups/manishad/NMAR2/sim_results/long",
#                  .results.stitched.write.path = "/home/groups/manishad/NMAR2/sim_results/overall_stitched",
#                  .name.prefix = "long_results",
#                  .stitch.file.name="stitched.csv")

.results.singles.path = "/home/groups/manishad/NMAR2/long_results"
.results.stitched.write.path = "/home/groups/manishad/NMAR2/stitched_results"
.name.prefix = "long_results"
.stitch.file.name="stitched.csv"
...
# scp mmathur@login.sherlock.stanford.edu:/home/groups/manishad/NMAR2/stitched_results/* /Users/mmathur/Dropbox/Personal computer/Independent studies/*Inchoate/2022/NMAR2/Linked to OSF (NMAR2)/Simulation study/Data
